...
public class SafeStashPLTEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SafeStashPLTEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SafeStashPLTIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SafeStashPLTIW/InitOutcome.xml").getDocumentElement();
